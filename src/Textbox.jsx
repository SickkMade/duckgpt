...
function textbox({HandleKeyDown, SendMessage, setUserInputValue, inputRef}) {
  return (
    ...
    <input ref={inputRef} type="text" className="textbox" placeholder='Message ChatGPT' onChange={(e) => setUserInputValue(e.target.value)} onKeyDown={HandleKeyDown}required/>
